    ...
    <div class="-mx-4 flex flex-wrap">
      <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
        <div class="mb-10 w-full">
          <a href="javascript:void(0)" class="mb-6 text-4xl font-bold inline-block max-w-[160px]">
          Event<span className="text-red-600">X</span>
          </a>
      ...
      <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
        <div class="mb-10 w-full">
          ...
          <p class="text-body-color text-base">&copy; 2023 EventX</p>
        </div>
      </div>
    </div>
  </div>
...
<p className="text-center">&copy;Copyrights 2023 Event   <span className="text-xl text-red-600">X</span>.com</p>
        </div>
    );
};
