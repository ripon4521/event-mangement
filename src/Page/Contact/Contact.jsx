...
const Contact = () => {
  useEffect(()=>{
    ...
    return (
        <div data-aos="fade-up" className='mt-[200px]'>
              <h1 className='text-center text-6xl font-bold   '>Contact  <span className='text-red-500'>Us</span></h1>
    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      ...
      <div data-aos="fade-right" className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          ...
          If your are interested on Our services, this Contact our Support Team. 
          </p>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">(+62)012302188446</p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">web.dev.ripon@gmial.com</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div data-aos="fade-left" className="w-full   px-4 lg:w-1/2 xl:w-5/12">
        <div className="relative rounded-lg shadow-md bg-[#f7f6f2]  p-8 sm:p-12">
          <form>
            <div className="mb-6">
              <input
                type="text"
